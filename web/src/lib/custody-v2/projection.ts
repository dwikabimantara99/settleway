...
export async function applyChainCustodyProjection(input: { repository: IRepository; adminWriter: ICustodyV2AdminWriter;
  ...
  const updated = await input.adminWriter.updateCustodyDealLink(input.applicationDealId, {
